...
def fetch(url):
    ...
    return s
errors=[];count=0
files=list((ROOT/'powerbi/Silverstone/Silverstone.Report').rglob('*.json'))+[ROOT/'powerbi/Silverstone/Silverstone.Report/definition.pbir',ROOT/'powerbi/Silverstone/Silverstone.pbip',ROOT/'powerbi/Silverstone/Silverstone.SemanticModel/definition.pbism']
for path in files:
...
(ROOT/'powerbi/Silverstone/schema_validation.json').write_text(json.dumps(result,indent=2))
